...
# Database: darth_eu
# Generation Time: 2012-09-24 18:06:10 +0000
# ************************************************************
...
VALUES
	...
	(5,'method','%%sidebarleadform%%','Lead capture form for sidebar',NULL,NULL,NULL,'public','side_lead_form',NULL,'sidelead',1,0),
...
VALUES
	...
	(7,8,'main','<div class=\"padded\">\n	<h3 class=\"emphasis\">Save up to 70% on Windows 7/8 Migration Costs</h3>\n	<p>The end of life for Windows XP is rapidly closing in, and Gartner stresses that companies should now be migrating to Windows 7/8 and be in the final stages by early 2013. Whether it&#39;s to move from Windows XP before support is discontinued or to upgrade from Windows Vista for better performance, Matrix42 can help companies save up to 70% on their migration costs.</p>\n	<p>This is accomplished by automating and simplifying every step of the process including hardware and software analysis, data backup and driver/operating system installation.  For example, Matrix42 <span class=\"bold\">Physical Workplace Management</span> automatically tests drivers, software and operating systems for errors to avoid expensive problems that need to be fixed after the migration.</p>\n	<p>One of the greatest concerns with an operating system migration is downtime and data loss. Matrix42&#39;s solution assesses an organization&#39;s readiness for Windows 7/8 migration with specific details on what needs to be upgraded before migration should begin. The user and data settings on each system are saved and reinstalled so end users don&#39;t lose productivity.</p>\n	%%getstartedpage%%\n	<p>In IT Administrator magazine&#39;s test of Windows migration tools, Matrix42 received the highest score. It was described as &quot;one step ahead of the competition with its application usage tracking,&quot; which lets an administrator see which applications are currently installed and in use so they don&#39;t waste time or money migrating unused applications.</p>\n	<p>Companies can also save money by taking advantage of desktop virtualization during their Windows update. Matrix42 Virtual Workplace Management automatically provisions the virtual desktops with everything end users need to work remotely.</p>\n	<div id=\"product-tab-container\" class=\"well margin-right\">\n		<ul id=\"product-tab\" class=\"nav nav-tabs\" data-tabs=\"product-tab\">\n			<li class=\"active\"><a href=\"#steps\" data-toggle=\"tab\">6 Steps to Migrate</a></li>\n		</ul><!-- product-tab -->\n		<div class=\"tab-container\">\n			<div class=\"tab-content\">\n				<div class=\"tab-pane active padded-content\" id=\"steps\">\n					<h3 class=\"emphasis\">6 Steps to a Successful Windows 7/8 Migration</h3>\n					<p>During Windows 7/8 migration, Matrix42 provides best-practice guidance that saves time, money and headaches by following 6 simple steps:</p>\n					<ul class=\"list\">\n						<li><strong class=\"emphasis\">Discover</strong> - Matrix42 automatically checks the hardware to ensure it meets Windows 7 or Windows 8 prerequisites. With just a few clicks, see which applications are installed and in use to determine only those which need to be migrated.</li>\n						<li><strong class=\"emphasis\">Analyze</strong> - System alerts of any updates that must or should be made to hardware, software and drivers prior to migration to significantly lower costs.</li>\n						<li><strong class=\"emphasis\">Test</strong> - Matrix42 eliminates errors by testing OS configurations, drivers and software.</li>\n						<li><strong class=\"emphasis\">Virtualize</strong> - Automatically deploy operating systems, drivers and software during a Windows 7/8 migration. This high level of automation reduces errors, help desk calls and the amount of time spent configuring hardware. Matrix42 ensures end users&#39; personal settings are maintained during the migration, so they can continue working as though no changes were made to their systems.</li>\n						<li><strong class=\"emphasis\">Deploy</strong> - Automatically deploy operating systems, drivers and software during a Windows 7/8 migration. This high level of automation reduces errors, help desk calls and the amount of time spent configuring hardware. Matrix42 ensures end users&#39; personal settings are maintained during the migration, so they can continue working as though no changes were made to their systems.</li>\n						<li><strong class=\"emphasis\">Operate</strong> - When the migration is complete, the system will release the updated PCs into the network and provide end users with access.</li>\n					</ul>\n				</div><!-- steps -->\n			</div><!-- tab-content -->\n		</div><!-- tab-content -->\n	</div><!-- product-tab-container -->\n</div><!-- padded -->',NULL),
	...
	(20,17,'main','<div class=\"padded\">\n	<p>Administrators can quickly create and record software packages using the Matrix42 Package Robot. The recorded installation packages can then be repeated over and over again with the click of a button. Users simply launch the executable file to perform the complete error-free installation process. It is so easy to use, even “newbies” with no technical knowledge can use the product to create packages.</p>\n	<p>Matrix42 Package Robot goes way beyond standard packaging methods. The program detects typos and text similarities and matches entries or window text with default specifications. It also features web content packaging and accounts for registry forms and browser windows commonly used for installation.</p>\n	<p>Updating and installing software can be a risky proposition even when only a few workstations are involved. This takes the burden off of IT, yet maintains the expert touch.</p>\n	%%getstartedpage%%\n	<a href=\"/assets/uploads/package-robot.pdf\" class=\"btn btn-icon margin-right left\"><span class=\"icon pdf\"></span>Data Sheet</a><a href=\"#lead-form-anchor\" class=\"btn btn-primary btn-icon left scroll main-lead\" data-campaign=\"10\" data-message=\"Package Robot Free Trial Request\"><span class=\"icon download\"></span>Free Trial</a>\n</div>',NULL),
	(21,16,'main','<div class=\"padded\">\n	<p>With Matrix42 Patch Management systems are kept up-to-date, running efficiently and more secure by ensuring they have the latest patches installed. It supports all Microsoft patches as well as patches from 30 other leading vendors to update the OS and other applications on both virtual and physical machines.</p>\n	<p>Administrators can prioritize and schedule patch updates, and each patch can be assigned to patch or service pack groups. Administrators can view comprehensive reports to see the status across the network or run a scan and fix to immediately update any identified problems. Matrix42 Patch Management can be used as an agentless or agent-based solution.</p>\n	%%getstartedpage%%\n	<a href=\"#lead-form-anchor\" class=\"btn btn-primary btn-icon left scroll main-lead\" data-campaign=\"11\" data-message=\"Patch Management Free Trial Request\"><span class=\"icon download\"></span>Free Trial</a>\n</div>',NULL),
	(22,14,'main','<div class=\"padded\">\n	<p>With Matrix42 Power Management, companies are able to save electricity and money, extend the lifespan of their computing equipment and protect the environment. This is accomplished by ensuring that computers and components only use the electricity they really need without affecting the ability of the end users.</p>\n	<p>Power configurations establish standard settings for when equipment such as computers, monitors and storage media should be powered on and off or to schedule regular maintenance windows for distributing applications and updates. Defined exceptions and end user override ensure machines are not powered off when important tasks are being performed. Administrators can see, via reports or a dashboard, the energy and money saved by the company as well as the reduction in CO2 emissions.</p>\n	%%getstartedpage%%\n	<a href=\"/assets/uploads/power-management.pdf\" class=\"btn btn-icon margin-right left\"><span class=\"icon pdf\"></span>Data Sheet</a><a href=\"#lead-form-anchor\" class=\"btn btn-primary btn-icon left scroll main-lead\" data-campaign=\"9\" data-message=\"Power Managment Free Trial Request\"><span class=\"icon download\"></span>Free Trial</a>\n</div>',NULL),
...
VALUES
	(11,8,'Windmark',0,'83.83.59.133','2012-09-12 13:41:48',NULL,1),
	(12,10,'Sydtotal AB',0,'88.131.108.2','2012-09-13 02:31:35',NULL,1);
...
VALUES
	(1,NULL,NULL,'public','main','Solutions','#','dropdown','','public','solutions','index','','','','sub-banner-woman.jpg','holistic workplace','The Solution That Solves your IT needs.',NULL,NULL,NULL,'',1,0,0),
	(2,NULL,NULL,'public','main','About','/about','dropdown',NULL,'public','about','index',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,3,0,0),
...
VALUES
	(1,11,11,NULL,'inquiry','Remote Control Free Trial Request','2012-09-12 14:41:48',0),
	(2,12,12,NULL,'inquiry','Package Robot Free Trial Request','2012-09-13 03:31:35',0);
...
VALUES
	(1,'primary',11,'0302735225','north_america',0),
	(2,'primary',12,'46704541264','north_america',0);
...
VALUES
	...
	(11,'robertdewindt@windmark.nl','Robert',NULL,'Windt','bcrypt$2a$12$VImidWlEC30N4g4RAquEf.FzUnBDAv74z7JltZGV6IQImSTw6BDRi',NULL,NULL,'lead',0,NULL,'2012-09-12 14:41:48','2012-09-12 13:41:48',NULL,NULL,0,'83.83.59.133',0),
	(12,'mr@sydtotal.it','Mathias',NULL,'Roswall','bcrypt$2a$12$13Kftrcrt0PPh942zfaiXuSAEUDyXq2zg3AdHHy2SWm7eyviQRjOy',NULL,NULL,'lead',0,NULL,'2012-09-13 03:31:35','2012-09-13 02:31:35',NULL,NULL,0,'88.131.108.2',0);
