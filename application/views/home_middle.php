	...
	<div class="row">
		...
		<div class="span4 offset1">
			<div class="padded-top-half">
				<a href="#lead-form-anchor" class="scroll"><span class="icon play"></span></a><h3 class="no-margin">Who We are</h3>
				<div class="clear"></div>
		...
		<div class="span4 offset1">
			<div class="padded-top-half">
				<a href="#lead-form-anchor" class="scroll"><span class="icon play"></span></a><h3 class="no-margin">What We do</h3>
				<div class="clear"></div>
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer non sapien a mauris	mattis congue. Ut a erat arcu. Duis semper laoreet convallis.</p>
				<a href="/">Learn more &gt;&gt;</a>
			</div>
