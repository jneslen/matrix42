	...
	<div class="row">
		<div id="home-explanation" class="span6 dashed-right">
			<div class="padded-all">
				...
				<p>Matrix42 ist ein Pionier der Bereitstellung von Workplace Management-Lösungen und das einzige Unternehmen, das mobile, virtuelle und physische Umgebungen problemlos verwalten kann. Es ist auch das einzige Unternehmen, das diese Services über eine Cloud-basierte Plattform bereitstellt. IT-Administratoren können für Zugriff, Sicherheit und Compliance sorgen. Anwender können Daten und Services überall und jederzeit abrufen und im Rahmen der Unternehmensrichtlinien ihre eigenen Geräte und Services hinzufügen. Wesentlich ist, dass Matrix42 die Produktivität der Mitarbeiter, IT-Effizienz, Kosteneinsparungen und die Zufriedenheit der Anwender verbessert, was wiederum zur Profitabilität des Unternehmens beiträgt.</p>
			</div><!-- padded-all -->
		</div><!-- span6 -->
		<div class="span6">
			<div class="padded-all">
